...
describe('GIVEN a <Footer />', () => {
    it('THEN should render its children components', () => {
        ...
        expect(within(footerElement).getByRole('img', { name: 'Twitter logo' })).toBeInTheDocument()
        expect(within(footerElement).getByLabelText('GitHub')).toBeInTheDocument()
        expect(within(footerElement).getByRole('img', { name: 'GitHub logo' })).toBeInTheDocument()
        expect(within(footerElement).getByLabelText('LinkedIn')).toBeInTheDocument()
        expect(within(footerElement).getByRole('img', { name: 'LinkedIn logo' })).toBeInTheDocument()
